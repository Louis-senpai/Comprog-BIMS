    ...
    <div
        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                sidebar-toggle-item="">Residents</span>
                        ...
                        <ul id="dropdown-crud" class="hidden py-2 space-y-2 ">
                            <li>
                                <a href="residents.php"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Manage
                                    Residents</a>
                            </li>
                            <?php 
            if ($accountModel->verifyPermission('Add_Residents') || $accountModel->verifyRole('superadmin')):
              ?>
                            <li>
                                <a href="addResidents.php"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Add
                                    Residents</a>
                            </li>
                            <?php endif;?>
        ...
        <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
            ...
            <a href="settings.php" data-tooltip-target="tooltip-settings"
                class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
