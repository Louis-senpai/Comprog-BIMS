                                         ...
                                         // Retrieve data from the database
                                                         ...
                                                         if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                if ($accountModel->verifyRole('superadmin')){
                                                                // Edit button
                                                                echo "<div>";
                                                                ...
                                                                if ($row['verified'] === null || $row['verified'] == 0) {
                                                                    ...
                                                                    echo "<button type='button' title='verify account' class='inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-lime-600 rounded-lg hover:bg-lime-800 focus:ring-4 focus:ring-lime-300 dark:focus:ring-lime-900'>";
