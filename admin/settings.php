                ...
                <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
                    ...
                    <div class="col-span-full xl:col-auto">
                        <div
                            ...
                            <img id="image_preview" class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0" src="../includes/images/<?php echo $_SESSION['image_url'];?>" alt="Profile Picture Preview">
                                <div>
                                    ...
                                    <form action="../api/upload.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="file" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" name="profile_image" id="profile_image" onchange="previewImage();">
                                    ...
                                    <li class="py-4">
                                        <div class="flex justify-between xl:block 2xl:flex align-center 2xl:space-x-4">
                                            ...
                                            <div class="inline-flex items-center w-auto xl:w-full 2xl:w-auto">
                                                <a href="#"
                                                    class="w-full px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Disconnect</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                    ...
                    <h1 class="col-span-3 text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">System settings</h1>
                    <div class="col-span-full xl:col-auto">
                        <div
                            class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                            <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                            <img id="image_preview1" class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0" src="../includes/images/<?php echo $Settings->getLogo();?>" alt="<?php echo $Settings->getLogo();?>">
                                <div>
                                    ...
                                    <form action="../api/upload.php" method="post" enctype="multipart/form-data">
                                        <div class="flex items-center space-x-4">
                                        <input type="file" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" name="system_logo" id="system_logo" onchange="previewImage1();">
