            ...
            <main>
                <div class="px-4 pt-6 pr-4">
                    <div class="mb-4">
                        ...
                        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Manage Backups
                        </h1>
                    </div>
                    <div class="sm:flex">
                        <div
                            ...
                            <div class="relative mt-1 lg:w-64 xl:w-96">
                                <input type="text" name="search" hx-get="/api/GetBackupRows.php"
                                    hx-target="#survey-data-rows" hx-swap="innerHTML"
                        ...
                        <div class="inline-block min-w-full align-middle">
                            <div class="overflow-hidden shadow">
                                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                    ...
                                    <tbody hx-get="/api/GetBackupRows.php?page=<?php echo $page?>" hx-trigger="load"
                                        hx-target="this" hx-swap="innerHTML" id="survey-data-rows"
                                        class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                        <!-- loading svg -->
                                        <tr class="h-[20rem]">
                                            <td colspan="9">
                                                <div id="Survey-data-rows-loading"
