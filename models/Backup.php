 ...
 */
define("DB_USER", 'u126067_6YObtWKgqn');
define("DB_PASSWORD", '!yQ4Q2@Da6BB!8VWIhLcKKMw');
define("DB_NAME", 's126067_student');
define("DB_HOST", 'delta.optiklink.com');
...
class Backup_Database {
     ...
     */
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8', $backupName) {
        $this->host                    = $host;
        ...
        $this->backupFile              = $backupName.'-'.date("Ymd_His", time()).'.sql';
    ...
    public function writeProgress($progress) {
        file_put_contents('backup_progress.txt', $progress);
    }
    ...
    public function backupTables($tables = '*') {
        try {
            ...
            // calculate the progess of the backup
...
// }
if(isset($_GET['name'])){
$backupDatabase = new Backup_Database($host, $user, $pass, $name, CHARSET, $_GET['name']);
