...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert the data
    $result = $surveyModel->updateSurvey($id, $surveyData);
    ...
    if ($result) {
        ...
        <div>
          <span class="font-medium">Success!</span> Resident '.$_POST['LastName'].', '.$_POST['FirstName'].' has Been Updated
        </div>
      </div>';
    } else {
        ...
        <span class="sr-only">Info</span>
        <div>
          <span class="font-medium">Danger</span> Resident didnt updated try changing something
        </div>
      </div>';
    }
}
